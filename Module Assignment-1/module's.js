...
fs.writeFileSync("indxe.html", "<html><head><title>FS Module</title><body><h1>Hello Node JS</h1></body></head></html>")

fs.readFileSync("file.text", "utf8")

fs.appendFileSync("file.text", "\nHello Backed Develpore")
fs.unlinkSync("indxe.html")
...
console.log(path.join(__dirname, "index.html", "modlue.js"))
